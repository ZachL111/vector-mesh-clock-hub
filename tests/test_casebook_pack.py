"""Regression checks for the vector-mesh-clock-hub casebook."""
...
from casebook.harness import assert_expected, vector_mesh_clock_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vector_mesh_clock_hub_summary(), assert_expected())
